...
require_relative "lib/polynom_diff/version"

Gem::Specification.new do |spec|
  spec.name = "polynom_diff"
  spec.version = PolynomDiff::VERSION
  spec.authors = ["Oleg-Demianenko"]
  spec.email = ["92909188+Oleg-Demianenko@users.noreply.github.com"]
